...
export const BlurImage = React.forwardRef(function BlurImage(
  ...
  return (
    <>
      <ModalOpener onClick={() => setShowOriginal(true)}>
        <div ref={ref} className='group'>
          <div className='relative'>
            <div className={`aspect-w-3 aspect-h-2 w-full overflow-hidden rounded-lg group-hover:rounded-none duration-700 bg-gray-200`}>
              <Image
      ...
      { showOrignial && <Modal onClose={() => setShowOriginal(false)}>
